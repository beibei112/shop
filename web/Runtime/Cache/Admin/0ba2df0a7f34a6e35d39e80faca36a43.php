...
<?php if(count($_SESSION["jump"]["error"]) > 0): ?><div class="mws-form-message error">
	...
	<div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
        	<form class="mws-form" action="/index.php/Admin/Adminuser/update" method='post'>
        	...
        	<input name='id' value='<?php echo ($vo['id']); ?>' type='hidden' />
        		...
        		<div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input type="text" class="small" value='<?php echo ($vo['name']); ?>' placeholder='请输入您要修改的昵称'>
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <img width='300px' src="/ThinkPhp/<?php echo ((isset($vo['pic']) && ($vo['pic'] !== ""))?($vo['pic']):"Public/Upload/aaa.jpg"); ?>">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input type="text" class="small" value='<?php echo ($vo['email']); ?>' name='email' placeholder='请输入您要修改的邮箱'>
                        </div>
                    </div>

        			<div class="mws-form-row">
        				<label class="mws-form-label">Group List</label>
        				<div class="mws-form-item">
        					<select class="small" name='groupid'>
                                <?php if(is_array($grouplist)): foreach($grouplist as $key=>$v): ?><option value='<?php echo ($v['id']); ?>' <?php if($vo["groupid"] == $v["id"]): ?>selected<?php endif; ?> ><?php echo ($v['group_name']); ?></option><?php endforeach; endif; ?>
        					</select>
        				</div>
        			</div>
                </div>
