...
<!-- 管理员列表 -->
    <div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
            <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
               <form action='/index.php/Admin/Val/index' method='get'>
                        <div id="DataTables_Table_1_length" class="dataTables_length">
                            <label> Show
                                <select size="1" name="size" aria-controls="DataTables_Table_1">
                                    <option value="4" <?php if($_GET["size"] == 4): ?>selected<?php endif; ?>>4</option>
                                    <option value="28" <?php if($_GET["size"] == 28): ?>selected<?php endif; ?>>28</option>
                                    <option value="38" <?php if($_GET["size"] == 38): ?>selected<?php endif; ?>>38</option>
                                    <option value="48" <?php if($_GET["size"] == 48): ?>selected<?php endif; ?>>48</option>
                                </select>
                            entries</label>
                        </div>
                        <div class="dataTables_filter" id="DataTables_Table_1_filter">
                            <label>
                                Search: <input value='<?php echo ($_GET['val']); ?>' name='val' type="text" aria-controls="DataTables_Table_1" onclick='this.value=""'>
                            </label>
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <?php if(is_array($list)): foreach($list as $k=>$vo): if($k%2 == 0): ?><tr class="odd">
                            <?php else: ?>
                                ...
                                <td class=" ">
                                    <center>
                                    <a href="/index.php/Admin/Val/del/id/<?php echo ($vo['id']); ?>"><i class='icon-trash'></i></a>
                                </center>
                                </td>
        ...
        <form id="mws-validate" class="mws-form" enctype='multipart/form-data' action="/index.php/Admin/Val/insert" method='post'>
    ...
    function fun(obj){
      ...
      $.ajax({
        url:'/index.php/Admin/Val/changestatus',
        data:{id:id},
        type:'get',
      });
    }
