...
<html lang="en" class="no-js">
	...
	<title>login</title>
	<link rel="stylesheet" type="text/css" href="/ThinkPhp/Public/ad/login/css/normalize.css" />
	<link rel="stylesheet" type="text/css" href="/ThinkPhp/Public/ad/login/css/demo.css" />
	<!--必要样式-->
	<link rel="stylesheet" type="text/css" href="/ThinkPhp/Public/ad/login/css/component.css" />
	<!--[if IE]>
			...
			<div class="content">
				<div id="large-header" class="large-header">
					...
					<div class="logo_box">
						...
						<form action="/ThinkPhp/index.php/Admin/Login/checklogin" name="f" method="post">
...
<script src="/ThinkPhp/Public/ad/login/js/TweenLite.min.js"></script>
<script src="/ThinkPhp/Public/ad/login/js/EasePack.min.js"></script>
<script src="/ThinkPhp/Public/ad/login/js/rAF.js"></script>
<script src="/ThinkPhp/Public/ad/login/js/demo-1.js"></script>
