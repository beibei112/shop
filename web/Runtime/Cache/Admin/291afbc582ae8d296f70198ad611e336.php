...
<?php if(count($_SESSION["jump"]["error"]) > 0): ?><div class="mws-form-message error">
    ...
    <div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/ThinkPhp/index.php/Admin/Cate/update" method='post'>
                ...
                <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <select class="small" name='pid' disabled>
                                ...
                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><option value='<?php echo ($vo['id']); ?>'
                                        <?php if($vo["id"] == $v["pid"]): ?>selected<?php endif; ?>
                                    ><?php echo ($vo['cate']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="mws-form-row">
                        <label class="mws-form-label">子分类名称:</label>
                        <div class="mws-form-item">
                            <input type="text" class="small" value='<?php echo ($v['cate']); ?>' name='cate'>
                        </div>
                    </div>
