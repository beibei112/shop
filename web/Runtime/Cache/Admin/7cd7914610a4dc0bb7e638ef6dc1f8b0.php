	...
	<div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
            <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            	<form action='/index.php/Admin/Cate/index' method='GET'>
	                <div id="DataTables_Table_1_length" class="dataTables_length">
	                    <label>Show 
	                        <select size="1" name="size" aria-controls="DataTables_Table_1">
                                <option value="10" <?php if($_GET["size"] == 10): endif; ?>>10</option>
	                ...
	                <div class="dataTables_filter" id="DataTables_Table_1_filter">
	                    <label>Search: <input value = '<?php echo ($_GET['cate']); ?>' onclick='this.value=""' name = 'cate' type="text" aria-controls="DataTables_Table_1">
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <?php if(is_array($list)): foreach($list as $k=>$vo): if($k%2 == 0): ?><tr class="odd" pid="<?php echo ($vo['aa']); ?>" id="<?php echo ($vo['id']); ?>" style="display:none">
               				<?php else: ?>
               					<tr class="even" pid="<?php echo ($vo['aa']); ?>" id="<?php echo ($vo['id']); ?>" style="display:none"><?php endif; ?>
                                <td class=""><?php echo ($vo['id']); ?></td>
                                <td class="aa"><?php echo ($vo['cate']); ?></td>
                                <td class=""><?php echo ($vo['pid']?$vo['pid']:"顶级父类"); ?></td>
                        
                                <td class=""><?php echo taglist($vo['id']);?>

                                <td class=" ">
                                	<a href="/index.php/Admin/Cate/edit/id/<?php echo ($vo['id']); ?>"><i class='icon-pencil'></i></a> | 
                                	<a href="/index.php/Admin/Cate/del/id/<?php echo ($vo['id']); ?>"><i class='icon-trash'></i></a> |
                                    <a href="/index.php/Admin/Cate/smalladd/id/<?php echo ($vo['id']); ?>"> 
                                    
                                    <?php if(count(explode(',',$vo['path'])) == 2 || count(explode(',',$vo['path'])) == 3 ): ?><i class='icon-magic'></i></a><?php endif; ?>
                                    
                                    <span>|</span> <a href="/index.php/Admin/Cate/edittag/id/<?php echo ($vo['id']); ?>"><i class='icon-pie-chart-3'></i></a> 
                                </td>
