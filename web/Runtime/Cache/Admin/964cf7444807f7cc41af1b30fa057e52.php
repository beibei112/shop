...
<?php if(count($_SESSION["jump"]["error"]) > 0): ?><div class="mws-form-message error">
    ...
    <!-- 信息提示 -->
         <script type="text/javascript" charset="utf-8" src="/ThinkPhp/Public/ad/ueditor/ueditor.config.js"></script>
        <script type="text/javascript" charset="utf-8" src="/ThinkPhp/Public/ad/ueditor/ueditor.all.min.js"> </script>
        <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
        <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
        <script type="text/javascript" charset="utf-8" src="/ThinkPhp/Public/ad/ueditor/lang/zh-cn/zh-cn.js"></script>

        <form action='/ThinkPhp/index.php/Admin/Good/detail' method='post'>
            <input type='hidden' name='id' value='<?php echo ($id); ?>' >
            <script id="editor" type="text/plain" style="width:1024px;height:500px;">
                <?php echo ($detail); ?>
            </script>
            <button class='btn btn-info'>提交编辑</button>
        </form>
