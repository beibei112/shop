...
<?php if(count($_SESSION["jump"]["error"]) > 0): ?><div class="mws-form-message error">
		...
		<div class="mws-panel grid_8">
            ...
            <div class="mws-panel-body no-padding">
            	<form class="mws-form" action="/ThinkPhp/index.php/Admin/Picc/insert" enctype="multipart/form-data" method='post'>
            		<div class="mws-form-inline">
            			<div class="mws-form-row">
            				<label class="mws-form-label">name:</label>
            				<div class="mws-form-item">
            					<input type="text" class="small" name='name' placeholder='请输入您要上传图片的名称'>
            				</div>
            			</div>
            			...
            			<div class="mws-form-row">
            				...
            				<div class="mws-form-item">
            					<input type="file" class="small" name='picc' multiple>
            				</div>
            			</div>
