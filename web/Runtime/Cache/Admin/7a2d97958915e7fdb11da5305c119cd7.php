...
<!-- 管理员列表 -->
	<div class="mws-panel grid_8">
    	<div class="mws-panel-header">
        	<span>
        		<i class="icon-table"></i>轮播图列表
        	</span>
        </div>

        <div class="mws-panel-body no-padding">
            <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            	<form action='/index.php/Admin/Picc/index' method='get'>
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 178px;">Name
                            </th>
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <?php if(is_array($list)): foreach($list as $k=>$vo): if($k%2 == 0): ?><tr class="odd">
               				<?php else: ?>
                                ...
                                <td class="  " style='width:10%;' value='<?php echo ($vo['name']); ?>'><?php echo ($vo['id']); ?></td>
                                <td class="  " ><?php echo ($vo['name']); ?></td>
                                <td class=" sorting_1"><img style='width:200px;' src="/Public/Lunbotu/<?php echo ($vo['picc']); ?>"></td>
                                <td class=" "> 
                                	<a href="/index.php/Admin/Picc/del/id/<?php echo ($vo['id']); ?>"><i class='icon-trash'></i></a>
                                </td>
