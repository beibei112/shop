...
<?php if(count($_SESSION["jump"]["error"]) > 0): ?><div class="mws-form-message error">
                ...
                <form class="mws-form" action="" method=''>
                    <div class="mws-form-inline">
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                                <input type="text" class="small" readonly name='Tom' value='<?php echo ((isset($vo['name']) && ($vo['name'] !== ""))?($vo['name']):"Admin"); ?>'>
                            </div>
                        </div>
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                                <input type="text" class="small" readonly name='<?php echo ($vo['email']); ?>' value='<?php echo ($vo['email']); ?>'>
                            </div>
                        </div>
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                                <input type="text" class="small" readonly value='<?php echo date("Y-m-d H:i:s",$vo['last_login']);?>'>
                            </div>
                        </div>
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                                <input type="text" class="small" readonly value=
                                    <?php if($vo["ip"] == "::1"): ?>127.168.5.27<?php endif; ?>
                                >
                            </div>
                        </div>
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                                <input type="text" class="small" value='<?php echo ($vo['group_name']); ?>' readonly>
                            </div>
                        </div>
    ...
    <div id="mws-form-dialog">
        <form id="mws-validate" class="mws-form" enctype='multipart/form-data' action="/index.php/Admin/Index/update" method='post'>
